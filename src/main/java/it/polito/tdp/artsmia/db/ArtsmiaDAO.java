...
public class ArtsmiaDAO {
	...
	public List<Adiacenza> getAdiacenze(){
		String sql="SELECT eo1.object_id as obj1, eo2.object_id as obj2, COUNT(*) as peso FROM exhibition_objects AS eo1, exhibition_objects as eo2 WHERE eo1.exhibition_id = eo2.exhibition_id AND eo2.object_id > eo1.object_id GROUP BY eo1.object_id, eo2.object_id";
